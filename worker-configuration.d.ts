/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1d9f38461fc8275a07ff34754b6c1b6a)
// Runtime types generated with workerd@1.20260921.1 2026-06-17 nodejs_compat
interface __BaseEnv_Env {
	DISCORD_APPLICATION_ID: string;
	DISCORD_BOT_TOKEN: string;
	DISCORD_PUBLIC_KEY: string;
	DISCORD_PRESETS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_APPLICATION_ID" | "DISCORD_BOT_TOKEN" | "DISCORD_PUBLIC_KEY" | "DISCORD_PRESETS">> {}
}
